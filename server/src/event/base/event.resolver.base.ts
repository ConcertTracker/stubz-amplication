...
export class EventResolverBase {
  ...
  async eventsOpened(
    ...
    const results = await this.service.findEventsOpened(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => Venue, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "Venue",
    action: "read",
    possession: "any",
  })
  async venue(@graphql.Parent() parent: Event): Promise<Venue | null> {
