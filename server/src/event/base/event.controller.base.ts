...
export class EventControllerBase {
  ...
  @common.Get("/:id/eventsOpened")
  @ApiNestedQuery(ArtistFindManyArgs)
  async findManyEventsOpened(
    @common.Req() request: Request,
    @common.Param() params: EventWhereUniqueInput
  ): Promise<Artist[]> {
    const query = plainToClass(ArtistFindManyArgs, request.query);
    const results = await this.service.findEventsOpened(params.id, {
      ...query,
      select: {
        createdAt: true,
  ...
  @common.Post("/:id/eventsOpened")
  async connectEventsOpened(
    @common.Param() params: EventWhereUniqueInput,
    @common.Body() body: ArtistWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Patch("/:id/eventsOpened")
  async updateEventsOpened(
    @common.Param() params: EventWhereUniqueInput,
    @common.Body() body: ArtistWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/eventsOpened")
  async disconnectEventsOpened(
    @common.Param() params: EventWhereUniqueInput,
    @common.Body() body: ArtistWhereUniqueInput[]
  ): Promise<void> {
    const data = {
